...
export class ProductDetailsComponent implements OnInit {
  ...
  constructor(private _ActivatedRoute: ActivatedRoute, private _ProductsService: ProductsService, private _Router: Router, private _Title: Title) { }
  ...
  ngOnInit(): void {
    ...
    this._ProductsService.getSpecificProduct(this.productId).subscribe({
      next: (res) => {
        ...
        this._Title.setTitle(`${this.productData.title.split(" ", 2).join(" ")}: Fresh Cart`);
